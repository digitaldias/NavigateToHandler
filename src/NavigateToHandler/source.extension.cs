...
namespace NavigateToHandler
{
    internal sealed partial class Vsix
    {
        ...
        public const string Description = @"Adds a command that allows you to navigate to public or protected methods across the entire solution that consume the type under the cursor as a parameter. ";
